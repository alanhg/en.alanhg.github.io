...
$(document).ready(function () {
    ...
    var title = 'Attack on Life';
    var titleTyping = document.getElementsByClassName('site-title')[0];
    var i = 0;

    function createTitleTyping() {
        window.setTimeout(function () {
            if (i === title.length) {
                titleTyping.textContent = title;
            } else {
                titleTyping.textContent = title.slice(0, i++) + '_';
            }
            createTitleTyping();
        }, 250);
    }
